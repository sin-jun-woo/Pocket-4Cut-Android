...
**화면 자동 꺼짐 방지**: 설정 맨 위의 ‘화면’에서 켜고 끌 수 있습니다. 기본값은 꺼짐이며 휴대폰의 화면 꺼짐 시간을 따릅니다. 켜면 촬영을 포함한 앱 화면을 사용하는 동안 화면이 자동으로 꺼지지 않습니다. 앱을 벗어나면 휴대폰 설정을 따르며, 선택값은 앱을 다시 실행해도 유지됩니다.
