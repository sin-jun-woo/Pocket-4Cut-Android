...
이 문서는 **2026-09-22 신뢰성 개편 코드 커밋 `155ced0`**을 기준으로 합니다. 구현된 경로와 검증 완료 범위는 다릅니다. 실행한 검사·남은 문제·커밋 기준은 [작업 기록](docs/WORKLOG.md)을 확인하세요. 초기 기획 문서의 기술 스택이나 일정은 현재 구현의 근거가 아닙니다.
