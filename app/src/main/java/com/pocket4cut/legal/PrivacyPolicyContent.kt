...
object PrivacyPolicyContent {
    ...
    const val REVISED_DATE = "2026년 9월 22일"
...
3. 처리하는 정보 (기기 내)
· 촬영 원본, 편집 초안 및 콜라주 결과물: 앱 전용 공간에서 촬영·편집·저장·공유 기능 제공
...
5. 보관 및 파기
· 초안·완성본은 자동 만료하지 않습니다. 앱 삭제나 보관함의 명시적 삭제로 앱 소유 데이터를 제거할 수 있습니다.
...
· 촬영 원본·초안·완성 결과·세션 문서·사진첩 내보내기 기록은 제외합니다.
