...
$reelNames = @(
    'Pocket4Cut-Reels-Male-Narration-30s.mp4',
    'Pocket4Cut-Male-Narration.mp3',
    'Pocket4Cut-Narrator-Cover.jpg',
...
$reelZipPath = Join-Path $reelBase 'Pocket4Cut-Narrator-Reels-Package.zip'
