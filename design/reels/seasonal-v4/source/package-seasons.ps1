...
$reelNames = @(
    'Pocket4Cut-Reels-Seasons-Voice.mp4',
    'Pocket4Cut-Seasons-Narration.mp3',
    'Pocket4Cut-Seasons-Cover.jpg',
...
$reelZipPath = Join-Path $reelBase 'Pocket4Cut-Seasons-Reels-Package.zip'
